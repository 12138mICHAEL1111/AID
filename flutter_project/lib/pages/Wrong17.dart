...
import './Correct17.dart';
import 'package:adobe_xd/page_link.dart';
import './Item18.dart';
import './Item16.dart';

class Wrong17 extends StatelessWidget {
  Wrong17({
    Key key,
  }) : super(key: key);
  @override
      ...
      body: Stack(
        children: <Widget>[
          ...
          Transform.translate(
            ...
            child:
                // Adobe XD layer: '截屏2021-03-02 19.26.…' (shape)
                Container(
              width: 132.0,
              height: 130.3,
              decoration: BoxDecoration(
                ...
                image: DecorationImage(
                  image: const AssetImage('assets/images/95%.png'),
                  fit: BoxFit.fill,
                ),
              ),
            ),
