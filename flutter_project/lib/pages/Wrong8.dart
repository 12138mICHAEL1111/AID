...
import './Correct8.dart';
import 'package:adobe_xd/page_link.dart';
import './Item9.dart';
import './Item7.dart';

class Wrong8 extends StatelessWidget {
  Wrong8({
    Key key,
  }) : super(key: key);
  @override
      ...
      body: Stack(
        children: <Widget>[
          ...
          Transform.translate(
            ...
            child:
                // Adobe XD layer: '截屏2021-03-02 19.24.…' (shape)
                Container(
              width: 131.0,
              height: 131.0,
              decoration: BoxDecoration(
                ...
                image: DecorationImage(
                  image: const AssetImage('assets/images/47%.png'),
                  fit: BoxFit.fill,
                ),
              ),
            ),
