...
testWidgets('there should be exactly 1 Social option in this page', (WidgetTester tester) async{
    await tester.pumpWidget(createWidgetForTesting(child: new Selectcategoriespage()));
    await tester.pumpAndSettle();
    final option = find.text("Social");
    expect(option,findsOneWidget);
  });

  testWidgets('there should be exactly 1 Next button in this page', (WidgetTester tester) async{
    await tester.pumpWidget(createWidgetForTesting(child: new Selectcategoriespage()));
    await tester.pumpAndSettle();
  ...
  testWidgets('cannot navigate to next page when there is not exactly 6 options selected', (WidgetTester tester) async{
    await tester.pumpWidget(createWidgetForTesting(child: new Selectcategoriespage()));
    await tester.pumpAndSettle();
  ...
  testWidgets('can navigate to next page when there is exactly 6 options selected', (WidgetTester tester) async{
    dioAdapter
      .onGet(path)
      .reply(200, {'message': 'success'})
      .onPost(path)
  ...
  testWidgets('double click an option will unselect it', (WidgetTester tester) async{
    dioAdapter
      .onGet(path)
      .reply(200, {'message': 'success'})
      .onPost(path)
